...
F2837xD_Adc.obj: ../F2837xD_Adc.c $(GEN_OPTS) $(GEN_HDRS)
	...
	"C:/ti/ccsv6/tools/compiler/ti-cgt-c2000_6.4.3/bin/cl2000" -v28 -ml -mt --float_support=fpu32 --include_path="C:/ti/ccsv6/tools/compiler/ti-cgt-c2000_6.4.3/include" --include_path="E:/ti/controlSUITENew/device_support/F2837xD/v150/F2837xD_headers/include" --include_path="E:/ti/controlSUITENew/device_support/F2837xD/v150/F2837xD_common/include" -g --define=CPU1 --define=_FLASH --diag_warning=225 --display_error_number --diag_suppress=10063 --preproc_with_compile --preproc_dependency="F2837xD_Adc.pp" $(GEN_OPTS__FLAG) "$<"
